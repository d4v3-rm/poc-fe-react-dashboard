...
import { DEFAULT_THEME_PALETTE, getFallbackColor, toRgba } from '../shared/theme/color-utils';
...
export const AppProviders = ({ children }: AppProvidersProps) => {
  ...
  useEffect(() => {
    ...
    const trackColor = themeMode === 'dark' ? 'rgba(255, 255, 255, 0.06)' : 'rgba(16, 24, 40, 0.10)';
    ...
    const thumbStrong = toRgba(safeSecondary, themeMode === 'dark' ? 0.82 : 0.72);

    document.body.style.backgroundColor =
      themeMode === 'dark' ? DEFAULT_THEME_PALETTE.dark.layout : DEFAULT_THEME_PALETTE.light.layout;
