  ...
  return {
    ...
    token: {
      ...
      colorBgContainer: isDark
        ? DEFAULT_THEME_PALETTE.dark.panel
        : DEFAULT_THEME_PALETTE.light.panel,
      colorBgElevated: isDark
        ? DEFAULT_THEME_PALETTE.dark.panelStrong
        : DEFAULT_THEME_PALETTE.light.panelStrong,
      borderRadius: 14,
      borderRadiusLG: 18,
